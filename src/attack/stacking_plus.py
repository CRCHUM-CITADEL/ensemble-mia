...
def model(
    ...
    Gower distance is added as input to the meta classifier
    ...
    for i in range(iteration):
        ...
        # Make predictions with validation set (used to train the logistic regression)
        ...
        # Test set (used to evaluate the logistic regression)
        ...
        # Training set for the logistic regression
        df_val_lr = pd.concat(
            [
        ...
        # Test set for the logistic regression
        ...
        precision_top1_stacking_plus.append(precision_top_1)
        precision_top50_stacking_plus.append(precision_top_50)
        ...
        draw.prediction_vis(
            ...
            cont_col=cont_cols,
            n=1,
            save_path=save_path / f"stacking_plus_output_iter{i}.jpg",
            seed=seed,
        )

    return pred_proba, precision_top1_stacking_plus, precision_top50_stacking_plus
