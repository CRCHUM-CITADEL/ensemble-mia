...
def fit_pred(
    ...
    for i in range(iteration):
        ...
        if meta_classifier is not None:
            ...
            # Make predictions with validation set (used to train the meta classifier)
        ...
        # Test set (used to evaluate the meta classifier)
        ...
        meta_classifier_stacking_plus.append(meta_classifier)
