...
def fit_pred(
    ...
    for i in range(iteration):
        ...
        pred_proba_stacking_plus.append(y_pred_proba_final)
        meta_classifier_stacking_plus.append(pipe_lr)

    return {
        "pred_proba": pred_proba_stacking_plus,
