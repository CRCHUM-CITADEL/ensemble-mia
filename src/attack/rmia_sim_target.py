    ...
    for repo in repo_list:
        ...
        for folder in os.listdir(repo_path):
            ...
            if (
                ...
                ds_df[metadata["continuous"]] = ds_df[metadata["continuous"]].astype(
                    float
                )
                ...
                # Save array
                np.savetxt(
                    os.path.join(folder_path, "gower_matrix.csv"),
                    pairwise_gower,
                    delimiter=",",
                )
                ...
                np.savetxt(
                    os.path.join(folder_path, file_name), mean_dist, delimiter=","
                )
